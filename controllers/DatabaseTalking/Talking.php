...
class Talking {
    const   ORDER_BY_NAME_A_Z = 1;
    const   ORDER_BY_NAME_Z_A = 2;
    const   ORDER_BY_PRICE = 3;
    const   ORDER_BY_SELLING = 4;
    const   SEARCH_BOOK_NAME = 5;
    const   SEARCH_AUTHOR_NAME = 6;

    private static $username = 'root';
    private static $password = '';
    private static $dbName = 'book_store';//common books (best sellers)
    ...
    public function __construct() {
        ...
        try {
            $this->conn = new PDO('mysql:host=' . self::$hostname . ';dbname=' . self::$dbName, self::$username, self::$password, $options);
        ...
        try {
            $this->stat = $this->conn->prepare("
                SELECT b.book_id,
                    ...
                    b.actual_quantity,
                    b.description,
                    a.name as author,p.name as publisher_name
        ...
        try {
            $this->stat = $this->conn->prepare("
                SELECT b.book_id,
                    ...
                    b.description,
                    b.actual_quantity,
                    p.phone as publisher,p.phone as publisher_phone,sum(od.quantity) as co
...
");
     ...
     * @internal param max $int $limit od row he want and it's default =20.
     */
    ...
    public function cashBooks(int $search, string $str): void {
        ...
        try {
            ...
            echo $PDOException->getMessage() . (int)($PDOException->getCode());
        }
    }
/////////////////////////////////////////////////////////////////////////////////////////////////////
/// they do not test
